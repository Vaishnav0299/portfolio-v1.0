# 🚀 Vaishnav Gaware — Engineering Portfolio & Web Application (v2.0)
...
```
portfolio-v1.0/
├── .env.example          # Environment variable template (Web3Forms API key)
├── .gitignore            # Git ignore patterns
├── index.html            # Main HTML5 entry point & font loading scripts
├── package.json          # Project dependencies and script declarations
├── vercel.json           # Vercel deployment & URL rewrite routing rules
├── vite.config.js        # Vite bundler configuration & React plugin setup
├── public/               # Static assets & favicon icons
└── src/                  # Source code directory
    ├── App.jsx           # Root Application component & React Router routes
    ├── main.jsx          # React DOM root render entry point
    ├── index.css         # Global CSS design system, CSS variables & utilities
    ├── components/       # Reusable UI component modules
    │   ├── About.jsx             # About section card component
    │   ├── CommandPalette.jsx    # Global Quick Action modal (Ctrl+K)
    │   ├── Contact.jsx           # Interactive contact form & Web3Forms integration
    │   ├── Dashboard.jsx         # Portfolio metric visualizer & dashboard
    │   ├── Footer.jsx            # Dynamic footer & system status bar
    │   ├── Hero.jsx              # Hero banner component
    │   ├── LanguageStatsBar.jsx  # Code distribution statistics bar
    │   ├── Navbar.jsx            # Header navigation & theme toggle
    │   ├── ProjectModal.jsx      # Detailed project modal viewer
    │   ├── Projects.jsx          # Project grid & filter buttons
    │   ├── Skills.jsx            # Skill progress matrix cards
    │   ├── Terminal.jsx          # Interactive developer CLI terminal emulator
    │   ├── ThreeBackground.jsx   # Three.js WebGL particle background renderer
    │   ├── Timeline.jsx          # Milestone career timeline component
    │   └── Toast.jsx             # Floating notification toast component
    ├── data/             # Centralized application data store
    │   └── portfolioData.js     # Project models, skills matrix, bio & timeline data
    ├── pages/            # Top-level route pages
    │   ├── AboutPage.jsx         # About section view
    │   ├── ContactPage.jsx       # Contact form view
    │   ├── DashboardPage.jsx     # Analytics view
    │   ├── Home.jsx              # Combined homepage view
    │   ├── ProjectsPage.jsx      # Projects showcase page
    │   ├── SkillsPage.jsx        # Skills matrix page
    │   └── TerminalPage.jsx      # Fullscreen terminal CLI page
    └── utils/            # Helper routines and utility functions
```
...
Copy the `.env.example` file to create a local `.env` file for contact form functionality:
```bash
cp .env.example .env
```
Open `.env` and configure your Web3Forms access key:
```env
...
To generate a minified, production-ready static build bundle:
```bash
npm run build
```
...
The repository includes a pre-configured `vercel.json` file supporting single-page application (SPA) client-side routing rewrites:
